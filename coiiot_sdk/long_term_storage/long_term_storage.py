...
class InsertT(abc.ABC):
    ...
    @abc.abstractmethod
    def value(self, tag: TagT, value: Any, timestamp: datetime):
        pass
...
class SelectT(abc.ABC):
    ...
    @abc.abstractmethod
    def with_period_minute(self) -> 'SelectT':
        pass

    @abc.abstractmethod
    def with_period_hour(self) -> 'SelectT':
        pass

    @abc.abstractmethod
    def with_period_day(self) -> 'SelectT':
        pass

    @abc.abstractmethod
    def with_period_month(self) -> 'SelectT':
        pass

    @abc.abstractmethod
    def with_period_year(self) -> 'SelectT':
        pass
...
def execute(query, unnamed_params: Optional[List] = None, named_params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
    pass
